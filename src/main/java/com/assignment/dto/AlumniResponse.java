...
public class AlumniResponse {
	...
	public String toString() {
		return "AlumniResponse [name=" + name + ", currentRole=" + currentRole + ", university=" + university
				+ ", location=" + location + ", linkedinHeadline=" + linkedinHeadline + ", passoutYear=" + passoutYear
				+ "]";
	}
